...
// if (isCompanyPage() || isLinkedInPage()) {
...
//   // Instagram like button - typically a button with a heart SVG icon
...
//   // Try to find the like button by SVG heart icon
//   const heartButtons = firstPost.querySelectorAll('svg[aria-label="Like"]');
//   if (heartButtons.length > 0) {
//     // The SVG is usually inside a button
//     const svg = heartButtons[0];
...
//   const likeButton = firstPost.querySelector('button[aria-label*="Like"], button[aria-label*="like"]');
//   if (likeButton) {
//     return likeButton;
//   }

//   // Try generic button with SVG heart
//   const allButtons = firstPost.querySelectorAll('button');
...
//   // Fallback: search entire page for like button
//   const pageHeartButtons = document.querySelectorAll('svg[aria-label="Like"]');
//   if (pageHeartButtons.length > 0) {
//     const svg = pageHeartButtons[0];
//     const button = svg.closest('button');
//     if (button) {
//       return button;
//     }
...
//   // Log for debugging
//   console.log("Instagram like button not found. Possible reasons: not logged in, DOM changed, or selector mismatch.");
//   return null;
// }
